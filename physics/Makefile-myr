...
bin/program: bin/main.o bin/vector.o bin/collider.o bin/quaternion.o bin/ll.o
	g++ -o program bin/main.o bin/vector.o bin/collider.o bin/quaternion.o bin/ll.o

bin/main.o: cpp/Sources/main.cpp cpp/Headers/collider.h cpp/Headers/vector.h cpp/Headers/quaternion.h cpp/Headers/ll.h
	g++ -c cpp/Sources/main.cpp -o bin/main.o bin/ll.o
...
bin/ll.o: cpp/Sources/ll.cpp cpp/Headers/ll.h cpp/Headers/vector.h
